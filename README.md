...
No license file is included yet — **add a `LICENSE` (e.g. MIT) before publishing
this repo** so others know how they may use it. Note that AI generations are
subject to the terms of the providers you configure (fal.ai, Anthropic).
