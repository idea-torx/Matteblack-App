...
export const MODEL_PRICING_CONFIG: ModelPricingConfig[] = [
  ...
  { model_key: "h3-turbo-t2v", base_cost: 12, resolution_multipliers: { "480p": 0.625, "768p": 1.0 }, duration_multipliers: { "per_second": 1 }, feature_surcharges: null },
  { model_key: "h3-turbo-i2v", base_cost: 12, resolution_multipliers: { "480p": 0.625, "768p": 1.0 }, duration_multipliers: { "per_second": 1 }, feature_surcharges: null },
