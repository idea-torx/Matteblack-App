                ...
                {repos.map((r, i) => (
                  <div key={r.nameWithOwner} className={`gh-tile${r.writable ? " gh-tile--writable" : ""}`}>
                    ...
                    <div className="gh-tile-actions">
                      ...
                      <button type="button" className="gh-btn" disabled={busy === r.nameWithOwner} onClick={() => void sync(r.nameWithOwner)} title="Sync" aria-label="Sync"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12a9 9 0 0 1-15.5 6.2L3 16" /><path d="M3 12a9 9 0 0 1 15.5-6.2L21 8" /><path d="M21 3v5h-5" /><path d="M3 21v-5h5" /></svg></button>
                      <button type="button" className="gh-btn gh-remove" onClick={() => void detach(r.nameWithOwner)} title="Remove" aria-label="Remove"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 6h18" /><path d="M8 6V4h8v2" /><path d="M6 6l1 14h10l1-14" /></svg></button>
                    </div>
                  </div>
                ))}
