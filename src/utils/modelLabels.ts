...
const MODEL_INFO: Record<string, ModelInfo> = {
  ...
  "gpt-image-2.5-t2i": { displayName: "GPT Image 2.5", variation: "Text → Image" },
  "gpt-image-2.5-edit": { displayName: "GPT Image 2.5", variation: "Image → Image" },
  ...
  "h3-max-director": { displayName: "MiniMax H3 Max Director", variation: "Live session" },
  "h3-turbo-t2v": { displayName: "MiniMax H3 Max Turbo", variation: "Text → Video" },
  "h3-turbo-i2v": { displayName: "MiniMax H3 Max Turbo", variation: "Image → Video" },
